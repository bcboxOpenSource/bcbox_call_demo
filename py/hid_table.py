...
KEY_RIGHT_ALT = 0xE6
KEY_RIGHT_GUI = 0xE7
KEY_ROOT_FLICK_LEFT = 0xE8
KEY_ROOT_FLICK_RIGHT = 0xE9
KEY_ROOT_FLICK_UP = 0xEA
KEY_ROOT_FLICK_DOWN = 0xEB
KEY_ROOT_FLICK_LEFT_UP = 0xEC
KEY_ROOT_FLICK_LEFT_DOWN = 0xED
KEY_ROOT_FLICK_RIGHT_UP = 0xEE
KEY_ROOT_FLICK_RIGHT_DOWN = 0xEF
KEY_ROOT_FLICK_UP_LEFT = 0xF0
KEY_ROOT_FLICK_UP_RIGHT = 0xF1
KEY_ROOT_FLICK_DOWN_LEFT = 0xF2
KEY_ROOT_FLICK_DOWN_RIGHT = 0xF3
KEY_ROOT_UP_LEFT_FLICK = 0xF4
KEY_ROOT_UP_RIGHT_FLICK = 0xF5
KEY_ROOT_DOWN_LEFT_FLICK = 0xF6
KEY_ROOT_DOWN_RIGHT_FLICK = 0xF7
KEY_ROOT_LEFT_UP_FLICK = 0xF8
KEY_ROOT_LEFT_DOWN_FLICK = 0xF9
KEY_ROOT_RIGHT_UP_FLICK = 0xFA
KEY_ROOT_RIGHT_DOWN_FLICK = 0xFB
BIT0 = 0x01
BIT1 = 0x02
BIT2 = 0x04
BIT3 = 0x08
